...
def update_progress():
    ...
    style.configure("HP.Horizontal.TProgressbar", troughcolor=color_hp, background=color_hp)

    color_attack = '#%02x%02x%02x' % (255 - 2 * attack, 2 * attack, 0)
    style.configure("Attack.Horizontal.TProgressbar", troughcolor=color_attack, background=color_attack)

    color_defense = '#%02x%02x%02x' % (255 - 2 * defense, 2 * defense, 0)
    style.configure("Defense.Horizontal.TProgressbar", troughcolor=color_defense, background=color_defense)

    color_sp_atk = '#%02x%02x%02x' % (255 - 2 * sp_atk, 2 * sp_atk, 0)
    style.configure("SpAtk.Horizontal.TProgressbar", troughcolor=color_sp_atk, background=color_sp_atk)

    color_sp_def = '#%02x%02x%02x' % (255 - 2 * sp_def, 2 * sp_def, 0)
    style.configure("SpDef.Horizontal.TProgressbar", troughcolor=color_sp_def, background=color_sp_def)

    color_speed = '#%02x%02x%02x' % (255 - 2 * speed, 2 * speed, 0)
    style.configure("Speed.Horizontal.TProgressbar", troughcolor=color_speed, background=color_speed)
...
style.configure("Defense.Horizontal.TProgressbar", troughcolor='green', background='green')
style.configure("SpAtk.Horizontal.TProgressbar", troughcolor='purple', background='purple')
style.configure("SpDef.Horizontal.TProgressbar", troughcolor='orange', background='orange')
style.configure("Speed.Horizontal.TProgressbar", troughcolor='yellow', background='yellow')

progress_bar_hp = ttk.Progressbar(window, style="HP.Horizontal.TProgressbar",
...
progress_bar_attack = ttk.Progressbar(window, style="Attack.Horizontal.TProgressbar",
                                      orient="horizontal", length=200, mode="determinate")
progress_bar_attack.grid(row=9, column=1, pady=5)
progress_bar_attack.grid_remove()  # Ocultar la barra de progreso al inicio

progress_bar_defense = ttk.Progressbar(window, style="Defense.Horizontal.TProgressbar",
                                       orient="horizontal", length=200, mode="determinate")
progress_bar_defense.grid(row=10, column=1, pady=5)
progress_bar_defense.grid_remove()  # Ocultar la barra de progreso al inicio

progress_bar_sp_atk = ttk.Progressbar(window, style="SpAtk.Horizontal.TProgressbar",
                                      orient="horizontal", length=200, mode="determinate")
progress_bar_sp_atk.grid(row=11, column=1, pady=5)
progress_bar_sp_atk.grid_remove()  # Ocultar la barra de progreso al inicio

progress_bar_sp_def = ttk.Progressbar(window, style="SpDef.Horizontal.TProgressbar",
                                      orient="horizontal", length=200, mode="determinate")
progress_bar_sp_def.grid(row=12, column=1, pady=5)
progress_bar_sp_def.grid_remove()  # Ocultar la barra de progreso al inicio

progress_bar_speed = ttk.Progressbar(window, style="Speed.Horizontal.TProgressbar",
                                     orient="horizontal", length=200, mode="determinate")
